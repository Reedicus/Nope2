...
namespace FormExample
{
    public partial class Form1 : Form
    {
        ...
        public static Font font = new Font("Comic Sans", 12);
...
            int v = (int)(500 + 200 * Math.Sin(DateTime.Now.Millisecond / 50.0));
            ...
            e.Graphics.DrawString(running_fps.ToString(), font, Brushes.Black, 25, ClientSize.Height - 50);
            e.Graphics.DrawString(SquareCount.ToString(), font, Brushes.Black, 25, ClientSize.Height - 25);
        }
        ...
        protected override void OnKeyDown(KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.W)
            {
                SquareCount = SquareCount + 10;
            }
            if (e.KeyCode == Keys.E && SquareCount >=1 )
            {
                SquareCount = SquareCount - 1;
            }
            if (e.KeyCode == Keys.R && SquareCount >=11)
            {
                SquareCount = SquareCount - 10;
            }
            base.OnKeyDown(e);
