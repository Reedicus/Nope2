    ...
    public partial class Form1 : Form
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
           ...
           // int newY = 0;
            ...
            {
                for (int j = 0; j < ClientSize.Height; j += 27) {
                    e.Graphics.DrawRectangle(Pens.Black, new Rectangle(i, j, 25, 25));
                }
            }
           // for(int j; j>ClientSize.Width)
           // e.Graphics.DrawRectangle(Pens.Black, new Rectangle(newX, newY, 25, 25));
        }
